...
TEST(PathUtilTests, Basename)
{
    ...
    ASSERT_EQ(PathUtil::BasenameView("a/../b/c/d.e"), "d.e");
    ASSERT_EQ(PathUtil::BasenameView("a/b/c"), "c");
    ASSERT_EQ(PathUtil::BasenameView("/"), "");
    ASSERT_EQ(PathUtil::BasenameView(""), "");

#if FUSION_PLATFORM_WINDOWS
    ASSERT_EQ(PathUtil::BasenameView("C:/"), "");
#endif
}
...
TEST(PathUtilTests, Dirname)
{
    ...
    ASSERT_EQ(PathUtil::DirnameView("a/../b/c/d.e"), "a/../b/c");
    ASSERT_EQ(PathUtil::DirnameView("a/b/c"), "a/b");
    ASSERT_EQ(PathUtil::DirnameView("/"), "/");
    ASSERT_EQ(PathUtil::DirnameView(""), "");

#if FUSION_PLATFORM_WINDOWS
    ASSERT_EQ(PathUtil::DirnameView("C:/"), "C:/");
#endif
}
...
TEST(PathUtilTests, Extension)
{
    ...
    ASSERT_EQ(PathUtil::ExtensionView("a/../b/c/d.e"), "e");
    ASSERT_EQ(PathUtil::ExtensionView("a/b/c"), "");
    ASSERT_EQ(PathUtil::ExtensionView("/"), "");
    ASSERT_EQ(PathUtil::ExtensionView(""), "");

#if FUSION_PLATFORM_WINDOWS
    ASSERT_EQ(PathUtil::ExtensionView("C:/"), "");
#endif
}
